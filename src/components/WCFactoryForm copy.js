...
export const WCFactoryForm = ({ onSubmit, account, nftAddr }) => {
  ...
  let needToSet = false
  useEffect(() => {
    const nftAddrField = document.getElementById("nftAddr")
    console.log(nftAddrField.value)
    console.log({ nftAddr })
    if (nftAddr && !nftAddrField.value) needToSet = true
  }, [nftAddr])
            ...
            <Stack gap="0px">
              ...
              >
                ...
                <TextField
                  ...
                  helperText={
                    showErrs ? formik.errors.unlockInterval ?? " " : " "
                  }
                />
              </Stack>
